...
export function NewNoteCard() {
  ...
  function handleSaveNote(event: FormEvent) {
    ...
    toast.success('Nova criada com sucesso!')
  }

  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 p-5 gap-3 text-left outline-none hover:ring-2 hover:ring-slate-600 focus:ring-2 focus-visible:ring-lime-400">
